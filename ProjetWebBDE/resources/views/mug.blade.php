    ...
    <div class="row">
        <div class="col-12 col-sm-3">
            ...
            <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                    <img class="img-fluid" src="https://jcgeek.be/wp-content/uploads/2019/05/mug-chopper.jpg" />
                    <h5 class="card-title">Mug One piece</h5>
        ...
        <div class="col">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="https://jcgeek.be/wp-content/uploads/2018/12/mug-naruto-one-piece.png" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Mug Naruto</a></h4>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="https://jcgeek.be/wp-content/uploads/2018/12/mug-dbz-broly-2.png" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Mug Dbz</a></h4>
                            <p class="card-text">DESCRIPTION</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">6000DA</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="https://jcgeek.be/wp-content/uploads/2018/12/mug-naruto-one-piece.png" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Mug Naruto 2</a></h4>
                            <p class="card-text">DESCRIPTION</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">6000DA</p>
