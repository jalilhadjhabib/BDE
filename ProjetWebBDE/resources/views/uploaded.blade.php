...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Votre image a été Upload</h1>
        <p class="lead text-muted mb-0"></p>
        <a class="nav-link" href="http://127.0.0.1:8000/file"><button type="retour" class="btn btn-primary" style="margin-top:10px">Retour</button></a>
    </div>
</div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="{{route("accueil")}}">Page d'accueil</a></li>
