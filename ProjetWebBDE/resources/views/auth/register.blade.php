                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Mot de passe (Au moins une majuscule et un chiffre)</label>
                        ...
                        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                            <label for="type" class="col-md-4 control-label">
                             Type (BDE/Etudiant/Personel CESI)</label>
                            <div class="col-md-6">
...
<span class='ipsCustomInput'>
    ...
    >
        <div class='ipsFieldRow_content'>
            <label class='ipsFieldRow_label' for='check_b464c43ac63629a39e2eff12af3e1089'><strong>I agree to the <a href='http://127.0.0.1:8000/ml' data-ipsDialog data-ipsDialog-title='Registration Terms'>Terms of Use</a></strong> <span class='ipsFieldRow_required'></span></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
