...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">Bienvenue sur la boutique de D'Exia Goodies</h1>
        <p class="lead text-muted mb-0">Vouz trouverez ici la vente de nos produits.</p>
    </div>
</section>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title"><a href="{{route("product")}}" title="View Product">Tshirt</a></h4>
                                    <p class="card-text">DESCRIPTION</p>
                                    <div class="row">
                                        <div class="col">
                                            <p class="btn btn-danger btn-block">60000DA</p>
                                        </div>
                                        <div class="col">
                        ...
                        <div class="col-sm">
                            <div class="card">
                                <img class="card-img-top" src="https://n-et-ko.fr/wp-content/uploads/2018/07/DSC_0859-600x400.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title"><a href="{{route("product")}}" title="View Product">Sweat blue</a></h4>
                                    <p class="card-text">DESCRIPTION</p>
                                    <div class="row">
                                        <div class="col">
                                            <p class="btn btn-danger btn-block">60000DA</p>
                        ...
                        <div class="col-sm">
                            <div class="card">
                                <img class="card-img-top" src="https://n-et-ko.fr/wp-content/uploads/2018/07/DDC_0555.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title"><a href="{{route("product")}}" title="View Product">Sweat Noir</a></h4>
                                    <p class="card-text">DESCRIPTION</p>
                                    <div class="row">
                                        <div class="col">
                                            <p class="btn btn-danger btn-block">60000DA</p>
                        ...
                        <div class="col-sm">
                            <div class="card">
                                <img class="card-img-top" src=" https://n-et-ko.fr/wp-content/uploads/2018/07/DSC_0855.jpg" alt="Card image cap">
                                <div class="card-body">
                                    <h4 class="card-title"><a href="{{route("product")}}" title="View Product">Sweat vert</a></h4>
                                    <p class="card-text">DESCRIPTION</p>
                                    <div class="row">
                                        <div class="col">
                                            <p class="btn btn-danger btn-block">60000DA</p>
