    ...
    <div class="row">
        <div class="col-12 col-sm-3">
            ...
            <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                    <img class="img-fluid" src="https://n-et-ko.fr/wp-content/uploads/2018/07/DSC_0855.jpg" />
                    <h5 class="card-title"><a href="{{route("product")}}" title="View Product">Tshirt</a></h4>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Sweat</a></h4>
                            <p class="card-text">DESCRIPTION</p>
                            <div class="row">
                                <div class="col">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="https://catova-securite.com/wp-content/uploads/2019/03/2038-tshirt-gris-anthracite.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">T-shirt</a></h4>
                            <p class="card-text">DESCRIPTION</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">6000DA</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <img class="card-img-top" src="https://jcgeek.be/wp-content/uploads/2019/05/mug-chopper.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Mug</a></h4>
                            <p class="card-text">DESCRIPTION</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">6000DA</p>
