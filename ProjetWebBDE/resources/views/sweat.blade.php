    ...
    <div class="row">
        <div class="col-12 col-sm-3">
            ...
            <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                    <img class="img-fluid" src="https://n-et-ko.fr/wp-content/uploads/2018/07/DSC_0859-600x400.jpg" />
                    <h5 class="card-title">Sweat Blue</h5>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Sweat Noir</a></h4>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Sweat Vert</a></h4>
                            <p class="card-text">DESCRIPTION</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">6000DA</p>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><a href="product" title="View Product">Sweat Blue</a></h4>
                            <p class="card-text">DESCRIPTION</p>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">6000DA</p>
